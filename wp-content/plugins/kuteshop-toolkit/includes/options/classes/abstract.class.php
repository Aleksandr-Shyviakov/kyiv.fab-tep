...
if (!class_exists('OVIC_Abstract')) {
    abstract class OVIC_Abstract
    {
        ...
        public function __construct()
        {
            ...
            // enqueue scripts
            add_action('ovic_options_enqueue', array(&$this, 'enqueue_field_scripts'));
        }
        ...
        public function add_enqueue_google_fonts()
        {
                ...
                foreach ($this->fields as $field) {
                    ...
                    if ($field_type && $field_id) {
                        ...
                        if (class_exists($class_name)) {
                            if (method_exists($class_name, 'output') || method_exists($class_name,
            ...
            if (!empty($this->typographies)) {
                if (empty($this->args['async_webfont'])) {
                    ...
                    wp_enqueue_style($handle, esc_url($api),
                        array(), null
                    );
                } else {
                    ...
                    wp_localize_script('ovic-google-web-fonts',
                        'WebFontConfig', array(
                            'google' => array(
