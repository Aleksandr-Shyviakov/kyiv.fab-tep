...
if (class_exists('Vc_Manager') && !function_exists('kuteshop_load_default_templates')) {
    function kuteshop_load_default_templates($templates_data)
    {
    ...
    add_filter('vc_load_default_templates', 'kuteshop_load_default_templates');
}
