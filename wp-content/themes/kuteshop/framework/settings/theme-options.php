...
if (!class_exists('Kuteshop_Theme_Option') && class_exists('OVIC_Options')) {
    class Kuteshop_Theme_Option
    {
            ...
            $options[] = array(
                ...
                'sections' => array(
                    array(
                        ...
                        'fields' => array(
                            array(
                                'id'      => 'theme_style',
                                'type'    => 'select',
                                'title'   => esc_html__('Theme style', 'kuteshop'),
                                'options' => array(
                                    'default'  => esc_html__('Theme default ', 'kuteshop'),
                                    'carparts' => esc_html__('Theme Carparts', 'kuteshop'),
                                ),
                                'default' => 'default',
                            ),
                            array(
                            ...
                            array(
                                ...
                                'desc'  => esc_html__('Enter your Google Map API key. ',
                                        'kuteshop').'<a href="'.esc_url('https://developers.google.com/maps/documentation/javascript/get-api-key').'" target="_blank">'.esc_html__('How to get?',
                                        'kuteshop').'</a>',
                            ),
                            array(
                                ...
                                'default' => true,
                                'desc'    => esc_html__('Enable for using Themes setting each single page.',
                                    'kuteshop'),
                            ),
                            array(
                    ...
                    array(
                        ...
                        'title'  => esc_html__('Sidebar Settings', 'kuteshop'),
                        'fields' => array(
                            array(
                                'id'              => 'multi_widget',
                                'type'            => 'group',
                                'title'           => esc_html__('Multi Sidebar', 'kuteshop'),
                                'button_title'    => esc_html__('Add Sidebar', 'kuteshop'),
                                'accordion_title' => esc_html__('Add New Sidebar', 'kuteshop'),
                                'fields'          => array(
                                    array(
                                        'id'    => 'add_widget',
                                        'type'  => 'text',
                                        'title' => esc_html__('Name Sidebar', 'kuteshop'),
                                    ),
                                ),
                            ),
                        ),
                    ...
                    array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                'id'          => 'category_menu',
                                'type'        => 'select',
                                'title'       => esc_html__('Category menu', 'kuteshop'),
                                'options'     => 'menus',
                                'placeholder' => 'Select a menus',
                                'chosen'      => true,
                                'ajax'        => true,
                                'query_args'  => array(
                                    'data-slug' => true,
            ...
            $options[] = array(
                ...
                'fields' => array(
                    array(
                        ...
                        'options' => $this->get_footer_preview(),
                        'default' => 'default',
                    ),
                ),
            );
                    ...
                    'sections' => array(
                        ...
                        array(
                            ...
                            'fields' => array(
                                ...
                                array(
                                    'title'   => esc_html__('Items per row on landscape tablet( For grid mode )',
                                        'kuteshop'),
                                    'desc'    => esc_html__('(Screen resolution of device >=992px and < 1200px )',
                                        'kuteshop'),
                                ...
                                array(
                                    'title'   => esc_html__('Items per row on portrait tablet( For grid mode )',
                                        'kuteshop'),
                                    'desc'    => esc_html__('(Screen resolution of device >=768px and < 992px )',
                                        'kuteshop'),
                ...
                'fields' => array(
                    ...
                    array(
                        ...
                        'content' => '<a href="#" data-text-done="'.esc_attr__('%n transient database entries have been deleted.',
                                'kuteshop').'" class="button button-primary delete-transients"/>'.esc_html__('Delete Transients',
                                'kuteshop').'</a><span class="spinner" style="float:none;"></span>',
                    ...
                    array(
                        'id'      => 'update_database',
                        'type'    => 'content',
                        'content' => '<a href="#" data-text-done="'.esc_attr__('database entries have been updated.',
                                'kuteshop').'" class="button button-primary update-database"/>'.esc_html__('Update Database',
                                'kuteshop').'</a><span class="spinner" style="float:none;"></span>',
                        'title'   => esc_html__('Update Database', 'kuteshop'),
                        'desc'    => esc_html__('Database will be update for compare with new version theme, There is NO UNDO.',
                            'kuteshop'),
                        'after'   => ' <p class="ovic-text-success"></p>',
                    ),
                ),
                    ...
                    array(
                        ...
                        'fields' => array(
                            ...
                            array(
                                'id'          => 'primary_menu',
                                'type'        => 'select',
                                'title'       => esc_html__('Header Primary', 'kuteshop'),
                                'placeholder' => esc_html__('Select a menu', 'kuteshop'),
                                'options'     => 'menus',
                                'chosen'      => true,
                                'ajax'        => true,
                                'query_args'  => array(
        ...
        public function install_taxonomy_options()
        {
            ...
            OVIC_Taxonomy::instance(apply_filters('kuteshop_framework_taxonomy_options', $sections));
        }
    }
