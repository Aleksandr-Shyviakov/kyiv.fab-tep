...
if ( ! function_exists( 'kuteshop_theme_color' ) ) {
	function kuteshop_theme_color()
	{
		...
		$main_color   = kuteshop_get_option_meta( '_custom_metabox_theme_options', 'kuteshop_main_color', 'metabox_kuteshop_main_color', '#ff3366' );
		$item_visible = kuteshop_get_option_meta( '_custom_metabox_theme_options', 'vertical_item_visible', 'metabox_vertical_item_visible', '10' );
		/* Main color */
		$css = '
        .block-nav-category .vertical-menu .menu-item:nth-child(n+' . ( $item_visible + 1 ) . '){
            display: none;
        }
        .main-color,
		a:hover,
		...
		.entry-summary .yith-ywraq-add-to-quote a:hover,
		...
		.woocommerce-form-register .user-role label:hover,
		...
		.kuteshop-products.style-19 .slick-slider:not(.nav-center) .slick-arrow:hover,
		.kuteshop-products.style-18 .slick-slider:not(.nav-center) .slick-arrow:hover
		{
			color: ' . $main_color . ';
		}
		.main-bg,
        ...
        .product-item.style-20 .product-inner .flash > span:not(.onnew),
        .product-item.style-19 .product-inner .flash > span:not(.onnew),
        .product-item.style-18 .product-inner .flash > span:not(.onnew),
        .kuteshop-socials.style-rounded .socials li a:hover span,
...
if ( ! function_exists( 'kuteshop_vc_custom_css_footer' ) ) {
	function kuteshop_vc_custom_css_footer()
	{
		...
		$footer_options        = kuteshop_get_option_meta( '_custom_metabox_theme_options', 'kuteshop_footer_options', 'kuteshop_metabox_footer_options' );
...
if ( ! function_exists( 'kuteshop_write_custom_scripts ' ) ) {
	function kuteshop_write_custom_scripts()
	{
		$scripts = kuteshop_get_option( 'kuteshop_custom_js', '' );
		if ( ! empty( $scripts ) ) {
			wp_add_inline_script( 'kuteshop-script', $scripts );
		}
	}

	add_action( 'wp_enqueue_scripts', 'kuteshop_write_custom_scripts' );
}