(function ( $ ) {
    ...
    $.fn.reload_content_items = function () {
        var self   = $( this ),
            ...
            button = self.find( '.ovic-menu-settings' ),
    ...
    $( document ).on( 'click', '.load-content-iframe', function ( e ) {
        ...
        var button  = $( this ),
            ...
            content = button.closest( '.ovic-menu-tab-builder' ),
    ...
    $( document ).on( 'click', '.ovic-menu-save-settings', function ( e ) {
        ...
        var button            = $( this ),
            ...
            item_title        = item_current.find( '.ovic-menu-settings' ).data( 'item_title' ),
            ajax_action       = {
                type: 'POST',
                url: ovic_megamenu_backend.ajaxurl,
                data: {
                ...
                success: function ( response ) {
                    ...
                    form.find( '.ovic-menu-tab-builder' ).removeClass( 'save-loading' );
        ...
        button.html( 'Saving..' );
        form.find( '.ovic-menu-tab-builder' ).addClass( 'save-loading' );
