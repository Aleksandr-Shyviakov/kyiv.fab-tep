...
if ( ! class_exists( 'Kuteshop_Visual_Composer' ) ) {
	class Kuteshop_Visual_Composer
	{
		...
		public function __construct()
		{
			...
			add_filter( 'generate_carousel_data_attributes', array(
				$this,
				'generate_carousel_data_attributes'
			), 10, 2 );

			add_filter( 'vc_iconpicker-type-kuteshopcustomfonts', array(
				$this,
				'iconpicker_type_kuteshopcustomfonts'
			) );
		...
		{
			add_filter( 'vc_autocomplete_kuteshop_blog_post_ids_callback', array(
				$this,
				'vc_include_field_search'
			), 10, 1 );
			add_filter( 'vc_autocomplete_kuteshop_blog_post_ids_render', 'vc_include_field_render', 10, 1 );
			add_filter( 'vc_autocomplete_kuteshop_products_ids_callback', array(
				$this,
				'productIdAutocompleteSuggester'
			), 10, 1 );
			add_filter( 'vc_autocomplete_kuteshop_products_ids_render', array(
				$this,
				'productIdAutocompleteRender'
			), 10, 1 );
			add_filter( 'vc_autocomplete_kuteshop_banner_ids_callback', array(
				$this,
				'productIdAutocompleteSuggester'
			), 10, 1 );
			add_filter( 'vc_autocomplete_kuteshop_banner_ids_render', array(
				$this,
				'productIdAutocompleteRender'
			), 10, 1 );
		}
				...
				array(
					array(
						...
						'value'      => array(
							...
							esc_html__( 'Faded In', 'kuteshop' )                  => 'effect faded-in',
                            ...
                            esc_html__( 'Background Zoom', 'kuteshop' )           => 'effect background-zoom',
                            esc_html__( 'Background Slide', 'kuteshop' )          => 'effect background-slide',
                            esc_html__( 'Rotate Left In', 'kuteshop' )            => 'effect rotate-in rotate-left',
                            esc_html__( 'Rotate Right In', 'kuteshop' )           => 'effect rotate-in rotate-right',
                            esc_html__( 'Overlay Plus', 'kuteshop' )              => 'effect overlay-plus',
                            esc_html__( 'Overlay Cross', 'kuteshop' )             => 'effect overlay-cross',
                            esc_html__( 'Overlay Horizontal', 'kuteshop' )        => 'effect overlay-horizontal',
                            esc_html__( 'Overlay Vertical', 'kuteshop' )          => 'effect overlay-vertical',
						),
						'sdt'        => 'none',
					),
				)
				...
				array(
					...
					'params'                  => array(
						...
						array(
							...
							'dependency' => array(
								'element' => 'style',
								'value'   => array( 'style1', 'style3', 'style6' )
							),
						),
						array(
						...
						array(
							...
							'dependency' => array(
								'element' => 'style',
								'value'   => array( 'style2', 'style12', 'style14' )
							),
						),
						array(
							'type'       => 'number',
					...
					'params'      => array(
						...
						array(
							...
							'value'       => array(
								...
								'18' => array(
									'title'   => esc_html__( 'Style 18', 'kuteshop' ),
									'preview' => $this->product_style . 'content-product-style-18.jpg',
								),
								'19' => array(
									'title'   => esc_html__( 'Style 19', 'kuteshop' ),
									'preview' => $this->product_style . 'content-product-style-19.jpg',
								),
								'20' => array(
									'title'   => esc_html__( 'Style 20', 'kuteshop' ),
									'preview' => $this->product_style . 'content-product-style-20.jpg',
								),
							),
							'default'     => '1',
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								...
								'style4'  => array(
									'title'   => 'Style 04',
									'preview' => $this->preview_url . 'category/style4.jpg',
								),
							),
							'default'     => 'default',
							'admin_label' => true,
					...
					'params'   => array(
						array(
							...
							'value'       => array(
								...
								'style3'  => array(
									'title'   => 'Style 03',
									'preview' => $this->preview_url . 'banner/style3.jpg',
								),
								'style4'  => array(
									'title'   => 'Style 04',
									'preview' => $this->preview_url . 'banner/style4.jpg',
								),
								'style5'  => array(
									'title'   => 'Style 05',
									'preview' => $this->preview_url . 'banner/style5.jpg',
								),
							),
							'default'     => 'default',
							'admin_label' => true,
						...
						array(
							'type'       => 'dropdown',
							'heading'    => esc_html__( 'Banner Type', 'kuteshop' ),
							'param_name' => 'banne_type',
							'value'      => array(
						...
						array(
							'type'       => 'vc_link',
							'heading'    => esc_html__( 'Link tour', 'kuteshop' ),
							'param_name' => 'banner_tour',
							'dependency' => array(
								'element' => 'style',
								'value'   => array(
									'style5'
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Special Price', 'kuteshop' ),
							'param_name' => 'banner_high_light',
							'dependency' => array(
								'element' => 'style',
								'value'   => array(
									'style3',
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Number Products', 'kuteshop' ),
						...
						array(
							'type'       => 'textfield',
							'heading'    => esc_html__( 'Price Products', 'kuteshop' ),
					...
					'params'   => array(
						array(
							...
							'value'       => array(
								...
								'style5'  => array(
									'title'   => 'Style 05',
									'preview' => $this->preview_url . 'iconbox/style5.jpg',
								),
							),
							'default'     => 'default',
							'admin_label' => true,
						...
						array(
							...
							'value'      => array(
								esc_html__( 'Font Awesome', 'kuteshop' )  => 'fontawesome',
								esc_html__( 'Font Flaticon', 'kuteshop' ) => 'kuteshopcustomfonts',
								esc_html__( 'Font Image', 'kuteshop' )    => 'image',
							),
						),
						array(
							'type'       => 'attach_image',
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								...
								'style4'  => array(
									'title'   => 'Style 04',
									'preview' => $this->preview_url . 'newsletter/style4.jpg',
								),
							),
							'default'     => 'default',
							'admin_label' => true,
					...
					'params'      => array(
						array(
							...
							'value'       => array(
								...
								'style5'  => array(
									'title'   => 'Style 05',
									'preview' => $this->preview_url . 'custommenu/style5.jpg',
								),
							),
							'default'     => 'default',
							'admin_label' => true,
					...
					'params'      => array(
						...
						array(
							...
							'value'      => array(
								...
								esc_html__( 'Rounded', 'kuteshop' ) => 'style-rounded',
							),
							'std'        => '',
						),
					),
