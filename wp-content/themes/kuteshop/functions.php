...
if (!function_exists('kuteshop_theme_setup')) {
    function kuteshop_theme_setup()
    {
        ...
        register_nav_menus(array(
                ...
                'language_menu'   => esc_html__('Language Menu', 'kuteshop'),
            )
        );
        /*
            ...
            foreach ($widgets as $widget) {
                if (!empty($widget)) {
                    register_sidebar(array(
                            ...
                            'id'            => 'custom-sidebar-'.sanitize_file_name(strtolower($widget['add_widget'])),
...
if (!function_exists('kuteshop_body_class')) {
    function kuteshop_body_class($classes)
    {
        ...
        $theme_style = kuteshop_get_option_meta('_custom_metabox_theme_options', 'theme_style');
        $classes[]   = $my_theme->get('Name')."-".$my_theme->get('Version');
        $classes[]   = "theme-{$theme_style}";
...
if (!function_exists('kuteshop_scripts')) {
    function kuteshop_scripts()
    {
        ...
        $google_map_api = kuteshop_get_option('gmap_api_key', '');
        $param          = array(
            'sensor'    => false,
            'libraries' => 'places',
        );
        ...
        wp_register_script('kuteshop-maps-api', esc_url($map_api), array(), false, true);
        ...
        wp_localize_script('kuteshop-script', 'kuteshop_params', array(
                ...
                'growl_notice'        => apply_filters('kuteshop_growl_notice_params',
                    array(
                        ...
                        'removed_from_wishlist_text' => esc_html__('Product has been removed from wishlist!', 'kuteshop'),
