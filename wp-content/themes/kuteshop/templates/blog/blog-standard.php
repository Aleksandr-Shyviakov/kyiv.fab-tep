...
get_post_format();
$blog_full_content = kuteshop_get_option( 'blog_full_content' );
$css_class         = 'post-item';
				...
				<?php if ( $blog_full_content != 1 ) : ?>
                    ...
                    <ul class="post-meta">
                        <li class="author">
                            ...
                            <a href="<?php echo esc_url( $auth_permalink ); ?>">
								<?php the_author() ?>
                            </a>
                        </li>
            ...
            <div class="post-info">
				...
				<?php if ( $blog_full_content != 1 ) : ?>
                    <a class="button read-more screen-reader-text"
                       href="<?php echo esc_url( $permalink ); ?>"><?php echo esc_html__( 'Read more', 'kuteshop' ); ?></a>
				<?php endif; ?>
            </div>
        </article>
	<?php endwhile;
